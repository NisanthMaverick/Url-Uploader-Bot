...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7815307011:AAEiKRINiUXwX2s4vxdzqEtCJnoqv3qrnnk")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Urluploaderpronisanth_bot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "25713073"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "65a23aaa7a97f42475de52ed240af2f3")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "6927710017 1064639262 1072002664")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://leechpro:leechpro@leechpro2.0731z.mongodb.net/?retryWrites=true&w=majority&appName=LeechPro2")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002489964112")) # your log channel id and make bot admin in log channel with full right 
